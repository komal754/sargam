...
const Sidebar = () => {
    return (
        <div className='bg-[#015904] min-h-screen pl-[4vw]'>

            <img src={assets.logo} alt="" className="mt-5 w-[max(15vw,150px)] hidden sm:block" />
            <img src={assets.logo_small} alt="" className="mt-5 w-[max(10vw,60px)] mr-5 sm:hidden block" />
